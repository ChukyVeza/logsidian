...
// en la sección específica de MV del diario
// =============================================
// Buscar tareas en todo el vault//
TASK
// Especificar la carpeta donde buscar - en este caso el diario//
FROM "Registro/Diario"
// Filtrar: solo tareas en la sección "MV" que no están completadas//
WHERE meta(section).subpath = "MV" AND !completed
